...
const state = {
  ...
  auth: {
    ...
    clientID: '11c33e7bbbf673824d5b',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: 'f0a79f1c32cf813d030c41939b792225e676cb04'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'Demon277',  // 修改成你自己的 GitHub 账号
  copyright: '2019',  // 修改成你自己的
  recordNumber: null,  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'Demon277/DemonBlog',  // 记录 Issue 的仓库的全名「用户名/仓库名」
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/Demon277'  // 第三方站点的 url
    },
    {
      img: 'static/img/csdn.jpg',
      url: 'https://blog.csdn.net/qq_35656123'
    }
    // {
